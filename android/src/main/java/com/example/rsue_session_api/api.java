...
public class api {
  ...
  public static class SubjectInfo {
    ...
    private @Nullable List<String> rooms;
    public @Nullable List<String> getRooms() { return rooms; }
    public void setRooms(@Nullable List<String> setterArg) {
      this.rooms = setterArg;
    }
    ...
    public static final class Builder {
      ...
      private @Nullable List<String> rooms;
      public @NonNull Builder setRooms(@Nullable List<String> setterArg) {
        this.rooms = setterArg;
        return this;
      }
      public @NonNull SubjectInfo build() {
        SubjectInfo pigeonReturn = new SubjectInfo();
        pigeonReturn.setMark(mark);
        pigeonReturn.setDateTime(dateTime);
        pigeonReturn.setName(name);
        pigeonReturn.setTeachers(teachers);
        pigeonReturn.setRooms(rooms);
        return pigeonReturn;
      }
    }
    @NonNull ArrayList<Object> toList() {
      ...
      toListResult.add(rooms);
      return toListResult;
    }
    static @NonNull SubjectInfo fromList(@NonNull ArrayList<Object> list) {
      SubjectInfo pigeonResult = new SubjectInfo();
      ...
      Object rooms = list.get(4);
      pigeonResult.setRooms((List<String>)rooms);
      return pigeonResult;
    }
  }
  ...
  public static class GroupSchedule {
    ...
    private @NonNull List<SubjectInfo> exams;
    public @NonNull List<SubjectInfo> getExams() { return exams; }
    public void setExams(@NonNull List<SubjectInfo> setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"exams\" is null.");
      }
      this.exams = setterArg;
    }
    ...
    public static final class Builder {
      ...
      private @Nullable List<SubjectInfo> exams;
      public @NonNull Builder setExams(@NonNull List<SubjectInfo> setterArg) {
        this.exams = setterArg;
        return this;
      }
      public @NonNull GroupSchedule build() {
        GroupSchedule pigeonReturn = new GroupSchedule();
        pigeonReturn.setName(name);
        pigeonReturn.setExams(exams);
        return pigeonReturn;
      }
    }
    @NonNull ArrayList<Object> toList() {
      ...
      toListResult.add(name);
      toListResult.add(exams);
      return toListResult;
    }
    static @NonNull GroupSchedule fromList(@NonNull ArrayList<Object> list) {
      GroupSchedule pigeonResult = new GroupSchedule();
      Object name = list.get(0);
      pigeonResult.setName((String)name);
      Object exams = list.get(1);
      pigeonResult.setExams((List<SubjectInfo>)exams);
      return pigeonResult;
    }
  }
  private static class ScheduleAPICodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        case (byte)128:         
          return GroupSchedule.fromList((ArrayList<Object>) readValue(buffer));
        
        case (byte)129:         
          return SubjectInfo.fromList((ArrayList<Object>) readValue(buffer));
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value)     {
      if (value instanceof GroupSchedule) {
        stream.write(128);
        writeValue(stream, ((GroupSchedule) value).toList());
      } else 
      if (value instanceof SubjectInfo) {
        stream.write(129);
        writeValue(stream, ((SubjectInfo) value).toList());
      } else 
{
  ...
  public interface ScheduleAPI {
    @NonNull List<GroupSchedule> getAllGroups(@NonNull byte[] file);
    @NonNull GroupSchedule getGroupByName(@NonNull byte[] file, @NonNull String name);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              List<GroupSchedule> output = api.getAllGroups(fileArg);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              GroupSchedule output = api.getGroupByName(fileArg, nameArg);
              wrapped.add(0, output);
            }
            catch (Error | RuntimeException exception) {
              ArrayList<Object> wrappedError = wrapError(exception);
